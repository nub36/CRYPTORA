...
- **Регрессионные тесты:**
  ...
  - `e2e/uiRegression.spec.tsx` расширен до 8 тестов: бюджет ёмкости навигации,
    минимальный кегль текста шапки (11px), stacking-режим `1024–1279px`,
    каскад сжатия сервисных контролов и компактной панели поиска.
...
- **Итоги гейтов:** typecheck — 0 ошибок; unit — 145 тестов (24 файла);
  build — чистая production-сборка; E2E — 47 тестов; screenshot QA — 0 нарушений.
