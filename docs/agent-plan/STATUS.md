...
> **Текущая версия:** v0.8.23 (Этап 6: система алертов Telegram/Webhook; потоки ликвидаций Bybit + OKX — v0.8.22; UX-цикл E — v0.8.21; п. 5 workspace — v0.8.20; п. 4 темы — v0.8.19; п. 3 типографика — v0.8.18; архив стратегий C1–C8 — v0.8.17)  
