...
> Прежние записи «production = v0.8.3» неверны. Версии v0.8.5–v0.8.38 на VPS **не выкатывались** (деплой не заказан).  
...
### v0.8.38 — Тарифы без иллюзии покупки
