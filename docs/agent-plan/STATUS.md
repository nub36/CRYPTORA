...
> **Текущая версия:** v0.8.21 (UX-цикл E: визуальная полировка/контраст обеих тем; п. 5 workspace — v0.8.20; п. 4 темы — v0.8.19; п. 3 типографика — v0.8.18; архив стратегий C1–C8 — v0.8.17)  
