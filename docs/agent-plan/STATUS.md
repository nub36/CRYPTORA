...
> **Текущий этап:** Этап 6 — фактический поток ликвидаций: устранение выдуманных агрегатов и подключение реального WS-потока (пункт 1 из 4).  
...
- [ ] Пункт 2: аналитическая тепловая карта плотности (2D цена × время) поверх модели `MODEL / ESTIMATED`.
