...
> **Текущая версия:** v0.8.22 (Этап 6: потоки ликвидаций Bybit + OKX; UX-цикл E — v0.8.21; п. 5 workspace — v0.8.20; п. 4 темы — v0.8.19; п. 3 типографика — v0.8.18; архив стратегий C1–C8 — v0.8.17)  
...
- Остаток Этапа 6: расширенная система алертов (Telegram/Webhook) — по указанию владельца ранее не стартовать; ждёт решения.
