...
> **Текущая версия:** v0.9.1 — UX-ПРОХОД ПО СКРИНШОТАМ (скан всех монет, колокольчик сигналов, графики)  
> **Текущий этап:** v0.9.1 completed: движок сканирует вселенную реестра + кастомные тикеры (Binance spot),
...
> свечи/бары/линия, MA-тумблер с легендой), /liquidations (цена+ликвидации на одном графике),
