...
- [ ] WebSocket шлюз для котировок, публичных сделок и стаканов L2.
- [ ] Математический движок детекции аномалий (Z-Score объемов, всплески активности) для Market Radar.
