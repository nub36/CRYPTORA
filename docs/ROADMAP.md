...
- [ ] **2. Системная русификация**: снять англо-дубли в скобках, латинские заголовки блоков (PRICE × TIME,
  ACTUAL EVENT LOG, ESTIMATED LIQUIDATION LEVELS, Long / Short), названия разделов навигации; латиница
  только у общепринятых аббревиатур.
