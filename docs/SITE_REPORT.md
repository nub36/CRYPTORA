...
3. Статических страниц не осталось: ecosystem → DeFiLlama v0.8.30, onchain → mempool.space v0.8.31, calendar → Binance v0.8.32, signals → пустой реестр v0.8.33. Живые ответы внешних API UNVERIFIED из песочницы — проверить при первом запуске в проде.
