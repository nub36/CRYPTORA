...
3. Статические страницы (§2: только /signals; ecosystem → DeFiLlama v0.8.30, onchain → mempool.space v0.8.31, calendar → Binance v0.8.32) — честно маркированы с v0.8.24, но ценность для пользователя ограничена, пока нет провайдеров.
