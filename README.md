...
- **Обзор (/):** капитализация, объём, доминация BTC/ETH, breadth и график BTC по фактическим данным Binance/KuCoin; индекс страха и жадности — из Alternative.me; 24h-дельты капитализации/объёма помечены `MODEL / ESTIMATED`.
...
- **Справочные разделы** (/signals, /onchain, /calendar, /ecosystem) — статические наборы, явно маркированы «СТАТИЧЕСКИЙ НАБОР».
