...
- **Обзор (/):** капитализация, объём, доминация BTC/ETH, breadth и график BTC по фактическим данным Binance/KuCoin; 24h-дельты и индекс страха/жадности помечены `MODEL / ESTIMATED`.
...
- **Скринер, Радар, Тепловые карты:** фильтры и детектор аномалий поверх LIVE-данных.
...
- **Справочные разделы** (/signals, /correlations, /onchain, /calendar, /ecosystem) — статические наборы, явно маркированы «СТАТИЧЕСКИЙ НАБОР».
