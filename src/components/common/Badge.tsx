...
export const Badge: React.FC<BadgeProps> = ({
  ...
  const variantClasses = {
    ...
    amber: 'bg-amber-950/60 text-amber-300 border border-amber-500/30 shadow-sm shadow-amber-950/30',
    ...
    demo: 'bg-amber-500/10 text-amber-300 border border-amber-500/35 hover:bg-amber-500/20 cursor-pointer shadow-sm shadow-amber-950/20',
  };
