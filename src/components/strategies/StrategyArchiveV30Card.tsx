  ...
  return (
    ...
    >
      ...
      <div className="text-[11px] text-slate-500">
        Остальные версии архива ({STRATEGY_ARCHIVE_PLANNED.length}: V2.1…V2.8, V3.1 — включая отклонённые и
        фальсифицированные) будут импортированы следующими шагами; версии не ранжируются напрямую из-за
