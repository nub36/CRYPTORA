    ...
    <div className="space-y-6 max-w-[1920px] mx-auto px-3 sm:px-4 py-3">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="bg-surface border border-surface-border rounded-lg p-4 font-mono">
          ...
          <div className="text-[10px] text-slate-500 mt-0.5">В залогах смарт-контрактов</div>
        </div>
        ...
        <div className="bg-surface border border-surface-border rounded-lg p-4 font-mono">
          ...
          <div className="text-[10px] text-slate-500 mt-0.5">1,850 TPS в реальном времени</div>
        </div>
      </div>
              ...
              {networks.map((net: NetworkEcosystem) => (
                <tr key={net.id} className="hover:bg-surface-elevated/40">
                  <td className="py-2.5 px-2 font-bold text-white flex items-center space-x-2">
                    <span>{net.name}</span>
                    <span className="text-[10px] text-slate-500 font-mono">({net.chainSymbol})</span>
                  </td>
