/* ARCHIVE-ONLY VERBATIM PORT — svechnoy-suslik-v2 scripts/real-data/limit-entry-replay.ts @ 4b25bbb (sha256 937dea115d74d291…).
 * Only import paths were rewritten (legacy/v2 siblings). Historical research code: never "improved", never wired to
 * LIVE signals, BacktestEngine or any execution path. CRYPTORA does not trade. */
/**
...
import { trackOutcome } from '../tracker';
