...
export const STRATEGY_ARCHIVE: readonly StrategyDefinition[] = Object.freeze([V30_DEFINITION]);
...
export const STRATEGY_ARCHIVE_PLANNED: readonly PlannedEntry[] = Object.freeze([
  { version: '2-baseline', name: 'Frozen SMC V2 engine (baseline)', sourceVerdict: 'BASELINE (negative expectancy)' },
  ...
  { version: '3.1', name: 'HTF Trend Pullback & Mitigation', sourceVerdict: 'FALSIFIED_ON_TRAIN' },
]);
