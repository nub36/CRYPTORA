...
export const DEMO_OVERVIEW: MarketOverviewData = {
  ...
  btcDominance: 53.8,
  ethDominance: 17.4,
  globalMarketCapUsd: 2450000000000,
  globalMarketCapChange24hPct: 2.45,
  globalMarketCapUpdatedAt: Date.now(),
  globalBtcDominancePct: 53.8,
  globalEthDominancePct: 17.4,
  fearAndGreed: {
    value: 64,
    sentiment: 'Greed',
    source: 'qa-fixture',
...
export const DEMO_LIQUIDATIONS: LiquidationData = {
  ...
  assetBreakdown: [
    { symbol: 'BTC', totalUsd: 63770000, longUsd: 14850000, shortUsd: 48920000, eventCount: 312, longEvents: 96, shortEvents: 216, largestEventUsd: 2400000 },
    { symbol: 'ETH', totalUsd: 28250000, longUsd: 8450000, shortUsd: 19800000, eventCount: 268, longEvents: 81, shortEvents: 187, largestEventUsd: 1750000 },
    { symbol: 'SOL', totalUsd: 17550000, longUsd: 2950000, shortUsd: 14600000, eventCount: 194, longEvents: 47, shortEvents: 147, largestEventUsd: 980000 },
    { symbol: 'SUI', totalUsd: 7270000, longUsd: 420000, shortUsd: 6850000, eventCount: 121, longEvents: 22, shortEvents: 99, largestEventUsd: 540000 },
    { symbol: 'PEPE', totalUsd: 5090000, longUsd: 890000, shortUsd: 4200000, eventCount: 108, longEvents: 31, shortEvents: 77, largestEventUsd: 410000 },
    { symbol: 'DOGE', totalUsd: 4700000, longUsd: 1250000, shortUsd: 3450000, eventCount: 96, longEvents: 29, shortEvents: 67, largestEventUsd: 360000 },
    { symbol: 'TAO', totalUsd: 4300000, longUsd: 180000, shortUsd: 4120000, eventCount: 54, longEvents: 9, shortEvents: 45, largestEventUsd: 290000 },
    { symbol: 'TIA', totalUsd: 2830000, longUsd: 2450000, shortUsd: 380000, eventCount: 47, longEvents: 33, shortEvents: 14, largestEventUsd: 250000 },
  ],
  exchangeBreakdown: [
    { exchange: 'Binance', totalUsd: 81650000, percentage: 54.0, eventCount: 412, state: 'connected', lastEventAt: new Date(Date.now() - 60000).toISOString() },
    { exchange: 'Bybit', totalUsd: 45360000, percentage: 30.0, eventCount: 289, state: 'connected', lastEventAt: new Date(Date.now() - 60000).toISOString() },
    { exchange: 'OKX', totalUsd: 24190000, percentage: 16.0, eventCount: 168, state: 'connected', lastEventAt: new Date(Date.now() - 60000).toISOString() },
  ],
  timeline: [
    { timestamp: '00:00', longUsd: 1200000, shortUsd: 3100000, totalUsd: 4300000, eventCount: 28, observed: true, startMs: Date.now() - 86400000, endMs: Date.now() - 75600000 },
    { timestamp: '03:00', longUsd: 2400000, shortUsd: 4800000, totalUsd: 7200000, eventCount: 41, observed: true, startMs: Date.now() - 75600000, endMs: Date.now() - 64800000 },
    { timestamp: '06:00', longUsd: 3800000, shortUsd: 7900000, totalUsd: 11700000, eventCount: 63, observed: true, startMs: Date.now() - 64800000, endMs: Date.now() - 54000000 },
    { timestamp: '09:00', longUsd: 9100000, shortUsd: 32400000, totalUsd: 41500000, eventCount: 187, observed: true, startMs: Date.now() - 54000000, endMs: Date.now() - 43200000 },
    { timestamp: '12:00', longUsd: 6500000, shortUsd: 21800000, totalUsd: 28300000, eventCount: 132, observed: true, startMs: Date.now() - 43200000, endMs: Date.now() - 32400000 },
    { timestamp: '15:00', longUsd: 4900000, shortUsd: 18200000, totalUsd: 23100000, eventCount: 104, observed: true, startMs: Date.now() - 32400000, endMs: Date.now() - 21600000 },
    { timestamp: '18:00', longUsd: 5800000, shortUsd: 14600000, totalUsd: 20400000, eventCount: 91, observed: true, startMs: Date.now() - 21600000, endMs: Date.now() - 10800000 },
    { timestamp: '21:00', longUsd: 4700000, shortUsd: 10000000, totalUsd: 14700000, eventCount: 73, observed: true, startMs: Date.now() - 10800000, endMs: Date.now() - 0 },
  ],
  timelineBucketMinutes: 180,
  timelineRangeLabel: 'QA-фикстура · 8 × 3ч',
  isDemo: true,
  observationStartedAt: Date.now() - 3 * 60 * 60 * 1000, // 3 hours ago for demo
  observationDurationMs: 3 * 60 * 60 * 1000,
  hasFullObservationWindow: false, // only 3h of observation, not full 24h
};
...
export class DemoMarketDataProvider implements MarketDataProvider {
  ...
  async getAssetDetail(symbol: string): Promise<AssetDetail | null> {
    ...
    return {
      ...
      atlDate: '2022-11-21T00:00:00.000Z',
      high24h,
      low24h,
      indicators: {
